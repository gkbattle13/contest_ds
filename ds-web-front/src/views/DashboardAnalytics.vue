  ...
  <div id="dashboard-analytics">
    <div class="vx-row">
      ...
      <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 mb-base">
        <!--        <statistics-card-line icon="DatabaseIcon" statistic="92.6k" statisticTitle="Subscribers Gained" :chartData="subscribersGained.series" type='area'></statistics-card-line>-->
        <statistics-card-line icon="DatabaseIcon" :statistic="dataTotal" statisticTitle="数据总行数"
          ...
          <div slot="no-body" v-if="supportTracker.analyticsData">
            <div class="vx-row text-center">
              ...
              <div
                ...
                <vue-apex-charts type=radialBar height=385 :options="analyticsData.supportTrackerRadialBar.chartOptions"
