<template>
  <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
    ...
    <vs-dropdown-menu class="w-48 i18n-dropdown vx-navbar-dropdown">
      ...
      <vs-dropdown-item @click="updateLocale('zh')"><img class="h-4 w-5 mr-1" src="@/assets/images/flags/zh.png" alt="pt" />  China</vs-dropdown-item>
    </vs-dropdown-menu>
  </vs-dropdown>
</template>
...
export default {
  computed: {
    ...
    getCurrentLocaleData() {
        ...
        else if (locale == "zh") return { flag: "zh", lang: 'China'     }
    },
  },
  methods: {
    updateLocale(locale) {
